...
public class Pointer {
     ...
     *
     * @param offset byte offset from pointer from which data is copied
     * @param buf    {@link com.sun.jna.Pointer} array into which data is copied
     * @param index  array index to which data is copied
     * @param length number of elements from native pointer that must be copied
     */
    ...
    */
     ...
     *
     * @param offset byte offset from pointer to perform the indirection
     * @return a {@link com.sun.jna.Pointer} equivalent of the pointer value
     ...
     * form {@link com.sun.jna.Native#getDefaultStringEncoding()}.
     *
    ...
    /** Read a native array of bytes of size <code>arraySize</code> from the
        given <code>offset</code> from this {@link com.sun.jna.Pointer}.
    */
    ...
    */
    ...
    /** Returns an array of {@link com.sun.jna.Pointer}.  The array length is
    ...
    /** Returns an array of {@link com.sun.jna.Pointer} of the requested size. */
