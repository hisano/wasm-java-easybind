 ...
 * Use method {@link com.sun.jna.VarArgsChecker#create() create()} to create an instance
 ...
 * on calls to {@link com.sun.jna.VarArgsChecker#isVarArgs(java.lang.reflect.Method) isVarArgs(Method)}.
 * @author Max Bureck
 */
abstract class VarArgsChecker {
    ...
    /**
     * Implementation always returning false when {@link com.sun.jna.VarArgsChecker.NoVarArgsChecker#isVarArgs(java.lang.reflect.Method)}
     * is called. This implementation will be chosen, if {@link java.lang.reflect.Method#isVarArgs()} is not available
     */
     ...
     * if {@link java.lang.reflect.Method#isVarArgs()} exists.
