 ...
 * {@link #invoke(Class,Object[], java.util.Map)} is the primary means to call
 * the function. </p>
 * <a name=callflags></a>
 * Function call behavior may be modified by passing one of the following call
 * flags:
 * <ul>
 * <li>{@link com.sun.jna.Function#C_CONVENTION} Use C calling convention (default)
 * <li>{@link com.sun.jna.Function#ALT_CONVENTION} Use alternate calling convention (e.g. stdcall)
 * <li>{@link com.sun.jna.Function#THROW_LAST_ERROR} Throw a {@link com.sun.jna.LastErrorException} if
...
public class Function extends Pointer {
     ...
     *
     * @param  library
     *                 {@link com.sun.jna.NativeLibrary} in which to find the function
     * @param  functionName
     *                 Name of the native function to be linked with
     * @param  callFlags
     *                 Function <a href="#callflags">call flags</a>
     ...
     * types are already at hand. When calling {@link com.sun.jna.Function#invoke(Class, Object[], java.util.Map)},
     * the method has to be in the options under key {@link com.sun.jna.Function#OPTION_INVOKING_METHOD}.
     */
    ...
    /** Provide a unique hash code for {@link com.sun.jna.Function}s which are
        equivalent.
    */
    @Override
    public int hashCode() {
