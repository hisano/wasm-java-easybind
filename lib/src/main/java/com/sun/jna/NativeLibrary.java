 ...
 * to map to the current process (see {@link com.sun.jna.NativeLibrary#getProcess()}).
 * <p>
 ...
 * com.sun.jna.Platform#getNativeLibraryResourcePrefix()}.  If bundled in a jar file, the
...
public class NativeLibrary {
     ...
     * @param libraryOptions Native library options for the given library (see {@link com.sun.jna.Library}).
     */
    ...
    /**
     * Create a new {@link com.sun.jna.Function} that is linked with a native
