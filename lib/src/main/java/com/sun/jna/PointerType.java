 ...
 * Derived classes may override the {@link com.sun.jna.NativeMapped#fromNative} method,
...
public abstract class PointerType implements NativeMapped {
    ...
    /** Convert this object to its native type (a {@link com.sun.jna.Pointer}). */
    @Override
    public Object toNative() {
        return getPointer();
    }

    /** Returns the associated native {@link com.sun.jna.Pointer}.
     ...
     * such as ensuring a single {@link com.sun.jna.PointerType} instance for each unique
     * {@link com.sun.jna.Pointer} value, or instantiating a different {@link com.sun.jna.PointerType}
     * subclass.
     */
    @Override
