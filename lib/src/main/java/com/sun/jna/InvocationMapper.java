 ...
 * {@link com.sun.jna.Native#load(String, Class, java.util.Map)} as an entry in
 * the options map with key {@link com.sun.jna.Library#OPTION_INVOCATION_MAPPER}.<p>
...
public interface InvocationMapper {
    /** Return an {@link java.lang.reflect.InvocationHandler} responsible for handling the
