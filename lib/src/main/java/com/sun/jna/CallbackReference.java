 ...
 * a Java {@link com.sun.jna.Callback} closure.
 */
public class CallbackReference extends WeakReference<Callback> {
    ...
    /**
     * @param cb The {@link com.sun.jna.Callback} instance
     * @param initializer The {@link com.sun.jna.CallbackThreadInitializer} - if {@code null} then the
    ...
    */
    ...
    /** Return a {@link com.sun.jna.Pointer} to the native function address for the
     * given callback.
     */
