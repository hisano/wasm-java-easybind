 ...
 * @see com.sun.jna.Library#OPTION_TYPE_MAPPER
 */
public class DefaultTypeMapper implements TypeMapper {
    ...
    /** Add a {@link com.sun.jna.ToNativeConverter} to define the conversion into a native
     ...
     * @param converter {@link com.sun.jna.ToNativeConverter} to transform an object of
    ...
    /**
     * Add a {@link com.sun.jna.FromNativeConverter} to convert a native result type into the
     ...
     * @param converter {@link com.sun.jna.FromNativeConverter} to transform a
    ...
    /**
     * Add a {@link com.sun.jna.TypeConverter} to provide bidirectional mapping between
     * a native and Java type.
     *
     * @param cls Java class representation for a native type
     * @param converter {@link com.sun.jna.TypeConverter} to translate between native and
     * Java types.
     */
