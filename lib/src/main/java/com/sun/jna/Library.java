 ...
 * {@link com.sun.jna.FunctionMapper} as a value for key {@link #OPTION_FUNCTION_MAPPER}
 * in the options map passed to the
 * {@link com.sun.jna.Native#load(String, Class, java.util.Map)} call.
 * <p>
 ...
 * {@link com.sun.jna.Native#synchronizedLibrary} to prevent simultaneous multi-threaded
 ...
 * {@link com.sun.jna.Native#load(String,Class, java.util.Map)} is made prior to instantiating
 ...
 * <p>
 * <b>OPTIONS</b> (an instance of {@link java.util.Map}),
 * <b>TYPE_MAPPER</b> (an instance of {@link com.sun.jna.TypeMapper}),
 * <b>STRUCTURE_ALIGNMENT</b> (one of the alignment types defined in
 * {@link com.sun.jna.Structure}), and <b>STRING_ENCODING</b> (a {@link String}) may also
...
public interface Library {
    /** Option key for a {@link com.sun.jna.TypeMapper} for the library. */
    String OPTION_TYPE_MAPPER = "type-mapper";
    /** Option key for a {@link com.sun.jna.FunctionMapper} for the library. */
    String OPTION_FUNCTION_MAPPER = "function-mapper";
    /** Option key for an {@link com.sun.jna.InvocationMapper} for the library. */
    String OPTION_INVOCATION_MAPPER = "invocation-mapper";
    /** Option key for structure alignment type ({@link Integer}), which should
     * be one of the predefined alignment types in {@link com.sun.jna.Structure}.
     */
     ...
     * </p>
     * Defaults to {@link com.sun.jna.Native#getDefaultStringEncoding()}.
     */
    ...
    */
    ...
    /** Flags to use when opening the native library (see {@link com.sun.jna.Native#open(String,int)}) */
    ...
    static class Handler implements InvocationHandler {
         ...
         * using the class in the double checked locking scenario of {@link com.sun.jna.Library.Handler#invoke(Object, java.lang.reflect.Method, Object[])}
         */
