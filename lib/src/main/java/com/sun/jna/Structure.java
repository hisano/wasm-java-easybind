 ...
 * {@link com.sun.jna.Native#getStructureAlignment} and {@link com.sun.jna.Native#getTypeMapper}.
 ...
 * declared abstract.
 * </p>
 * <p>You <em>must</em> annotate the class with {@link com.sun.jna.Structure.FieldOrder} or implement
 ...
 * example here)} if you prefer to use String in place of {@link com.sun.jna.WString} if
...
public abstract class Structure {
     ...
     * calling this method.
     * @return {@link java.util.Map} of field names to field representations.
     */
     ...
     * char*</code>.  Defaults to {@link com.sun.jna.Native#getDefaultStringEncoding()}.
     ...
     * memory.
     * @param m Memory to with which to back this {@link com.sun.jna.Structure}.
     */
    ...
    */
    ...
    /** Return a {@link com.sun.jna.Pointer} object to this structure.  Note that if you
     ...
     * {@link com.sun.jna.Function} object when it encounters a {@link com.sun.jna.Structure} argument
     * or return value.
     * The returned pointer may not have meaning for {@link com.sun.jna.Structure.ByValue}
     ...
     *
     * When defining a new {@link com.sun.jna.Structure} you shouldn't override this
     * method, but use {@link com.sun.jna.Structure.FieldOrder} annotation to define your field
     ...
     * this {@link com.sun.jna.Structure} class.
     */
    ...
    */
     ...
     * {@link com.sun.jna.Memory} backing, the memory will be resized to fit the entire
     * array.
    ...
    */
     ...
     * #newInstance(Class, com.sun.jna.Pointer)}, except that it additionally calls
