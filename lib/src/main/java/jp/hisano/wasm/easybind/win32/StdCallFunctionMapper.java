 ...
 */
package jp.hisano.wasm.easybind.win32;

import java.lang.reflect.Method;

import jp.hisano.wasm.easybind.Function;
import jp.hisano.wasm.easybind.FunctionMapper;
import jp.hisano.wasm.easybind.Native;
import jp.hisano.wasm.easybind.NativeLibrary;
import jp.hisano.wasm.easybind.NativeMapped;
import jp.hisano.wasm.easybind.NativeMappedConverter;
...
public class StdCallFunctionMapper implements FunctionMapper {
     ...
     *
     * @param library The {@link jp.hisano.wasm.easybind.NativeLibrary} instance
     * @param method The invoked {@link java.lang.reflect.Method}
