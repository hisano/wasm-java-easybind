...
import jp.hisano.wasm.easybind.internal.ReflectionUtils;
 ...
 * {@link Native#load(String, Class, java.util.Map)} call.
 * <p>
 ...
 * {@link Native#load(String,Class, java.util.Map)} is made prior to instantiating
...
//    String OPTION_ALLOW_OBJECTS = "allow-objects";
    ...
    static class Handler implements InvocationHandler {
         ...
         * using the class in the double checked locking scenario of {@link Library.Handler#invoke(Object, java.lang.reflect.Method, Object[])}
         */
