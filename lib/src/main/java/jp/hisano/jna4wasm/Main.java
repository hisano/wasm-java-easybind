...
public class Main {
	public static void main(String[] args) {
		try {
			...
			byte[] bytes = ByteStreams.toByteArray(Main.class.getResourceAsStream("/hello.wasm"));
			...
			Integer input_pointer = (Integer) instance.exports.getFunction("malloc").apply(subject.length)[0];
			...
			Integer output_pointer = (Integer) instance.exports.getFunction("hello").apply(input_pointer)[0];
