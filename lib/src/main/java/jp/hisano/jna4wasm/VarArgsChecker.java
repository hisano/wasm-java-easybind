 ...
 * on calls to {@link VarArgsChecker#isVarArgs(java.lang.reflect.Method) isVarArgs(Method)}.
 * @author Max Bureck
 */
abstract class VarArgsChecker {
    ...
    /**
     * Implementation always returning false when {@link VarArgsChecker.NoVarArgsChecker#isVarArgs(java.lang.reflect.Method)}
