...
//    }
    ...
    @Structure.FieldOrder({ "field0", "field1" })
    ...
    @Structure.FieldOrder({ "field0", "field1", "field2" })
    ...
    @Structure.FieldOrder({ "field0", "field1", "field2", "field3" })
    ...
    @Structure.FieldOrder({ "field2", "field3" })
...
//    }
    ...
    public void testThreadLocalSetReleasesReferences() {
        ...
        Structure.StructureSet structureSet = (Structure.StructureSet) Structure.busy();
