...
public class ArgumentsMarshalTest extends TestCase {
    ...
    public static interface TestLibrary extends Library {
        ...
        @Structure.FieldOrder({ "int8Field", "int16Field", "int32Field", "int64Field", "floatField", "doubleField" })
    ...
    public void testStructureByReferenceArrayArgument() {
        TestLibrary.CheckFieldAlignment.ByReference[] args = {
            new TestLibrary.CheckFieldAlignment.ByReference(),
            null,
            new TestLibrary.CheckFieldAlignment.ByReference(),
        };
...
//    }
    ...
    public void testUnionCallstack() {
        TestLibrary.MixedUnion1.ByValue union1 = new TestLibrary.MixedUnion1.ByValue();
        TestLibrary.MixedUnion1.ByValue union2 = new TestLibrary.MixedUnion1.ByValue();
