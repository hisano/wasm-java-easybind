...
function compile_all_files {
  ...
  compile define "['_call_void', '_call_two', '_call_boolean', '_call_Boolean', '_call_byte', '_call_Byte', '_call_short', '_call_Short', '_call_char', '_call_Character', '_call_int', '_call_Integer', '_call_long', '_call_Long', '_call_float', '_call_Float', '_call_double', '_call_Double', '_call_string', ${library_required_functions}]"
}
