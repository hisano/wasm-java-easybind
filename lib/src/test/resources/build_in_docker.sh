...
function compile_all_files {
  ...
  compile define "['_call_void', '_call_two', '_call_boolean', '_call_Boolean', '_call_byte', '_call_Byte', '_call_short', '_call_Short', '_call_char', '_call_Character', '_call_int', '_call_Integer', '_call_string', ${library_required_functions}]"
}
